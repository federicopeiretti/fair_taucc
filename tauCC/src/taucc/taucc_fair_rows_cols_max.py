    ...
    def _perform_row_move(self):
        ...
        if self.Sx is not None:
            if self.check_tau_fairness(self._tmp_row_assignment, "rows") == False:
                ...
                num_clusters = len(optimal_clusters)

                # Fair Assignment Problem
                fair_row_labels = self.fair_row_assignments(diff[:, optimal_clusters], num_clusters)
                ...
                self.individual_taus_x = all_tau[:, optimal_clusters][np.arange(len(fair_row_labels)), fair_row_labels]
    ...
    def _perform_col_move(self):
        ...
        if self.Sy is not None:
            if self.check_tau_fairness(self._tmp_col_assignment, "cols") == False:
                ...
                # Fair Assignment Problem
                fair_col_labels = self.fair_col_assignments(diff[:, optimal_clusters], num_clusters)
                ...
                self.individual_taus_y = all_tau[:, optimal_clusters][np.arange(len(fair_col_labels)), fair_col_labels]
