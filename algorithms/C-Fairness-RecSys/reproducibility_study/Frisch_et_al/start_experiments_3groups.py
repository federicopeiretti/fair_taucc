...
data = pickle.load(open(f"{root}/data/{dataset}_{sensitive_attribute}/{data_file}.pkl", "rb"))
block = args.block
...
age0 = (
    data["data_users"].userid[data["data_users"].age == "<35"].to_numpy()
)

age1 = (
    data["data_users"].userid[data["data_users"].age == "<50"].to_numpy()
)
...
directory += f"{sensitive_attribute}/"
create_path(directory)
