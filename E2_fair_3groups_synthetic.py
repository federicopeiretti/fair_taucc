        ...
        for fair_min1 in fair_minority_range:
            ...
            for fair_min2 in fair_minority_range2:
                ...
                for run in run_range:
                    print(f"majority = {fair_majority}, minority1 = {fair_min1}, minority2 = {fair_min2}, run = {run}")
